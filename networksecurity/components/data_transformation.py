...
class DataTransformation:
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
            ...
            # Saving the preprocessor object to the correct path as defined in the configuration.
            save_object( self.data_transformation_config.transformed_object_file_path, preprocessor_object,)
            logging.info(f"Preprocessor object saved to: {self.data_transformation_config.transformed_object_file_path}")
